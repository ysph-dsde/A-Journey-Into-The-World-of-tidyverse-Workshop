...
## It is possible to do the reverse operation of pivot_long(). The following
## code demonstrates how to reorient the code from a long- to wide-format.

covid19_death_raw_long |> 
  pivot_wider(
    # Denote the column of variables that will be expanded into new columns.
    names_from = date,
    # Denote which column of values the new cells will be filled from.
...
## state level from 2010 to 2023. This can be found in our JHU-CRC-Vaccinations
## GitHub page: https://github.com/ysph-dsde/JHU-CRC-Vaccinations
## 
